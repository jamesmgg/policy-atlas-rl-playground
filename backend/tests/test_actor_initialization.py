...
class TestDrivingActorInitialization(unittest.TestCase):
    ...
    def test_v5_checkpoint_protocol_records_exact_initialization_recipe(self) -> None:
        ...
        self.assertEqual(protocol["version"], 5)
...
class TestLanderExplorationInitialization(unittest.TestCase):
    ...
    def test_v5_metadata_records_exact_lander_exploration_recipe(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            root = Path(tmp)
